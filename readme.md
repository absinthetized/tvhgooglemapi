...
This header is used to store info in the form of:
...
header we can pop up the first opened gmail window/tab __of the given account__,
avoid confusion among multiple accounts and/or multiple sits monitoring the same account.
